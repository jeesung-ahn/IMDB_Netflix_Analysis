---
title: "Does International Collaboration Impact IMDB Ratings? (A Focus on Netflix)"
author: "Jeesung Ahn"
date: "03-03-2023"
output: 
  html_document:
...
* Dataset
  - Netflix Data: Sourced from [Kaggle](https://www.kaggle.com/datasets/shivamb/netflix-shows)
  - IMDB Data: Sourced from [IMDB Interfaces](https://www.imdb.com/interfaces/)
  - Netflix Original Data (as of 06.01.2021): Sourced from [Kaggle](https://www.kaggle.com/datasets/luiscorter/netflix-original-films-imdb-scores)
  - Financial Statistics: Sourced from [Business of Apps](https://www.businessofapps.com/data/netflix-statistics/)
...
# Netflix Originals: Is international collaboration associated with higher IMDB ratings? {.tabset}
